...
=== 아이디어 투표
operation::/ideas/put-idea[snippets='http-request,path-parameters,http-response,response-fields']
...
=== session 수정
operation::/sessions/put-idea[snippets='http-request,request-fields,path-parameters,http-response,response-fields']
